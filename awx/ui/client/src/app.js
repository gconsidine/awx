...
import start from '~src/app.start';
...
angular
    ...
    .constant('CONFIG', config.get())
    .constant('AngularScheduler.partials', `${config.get('ui.path.static')}lib/angular-scheduler/lib/`)
    .constant('AngularScheduler.useTimezone', true)
    .constant('AngularScheduler.showUTCField', true)
    .constant('$timezones.definitions.location', `${config.get('ui.path.static')}lib/angular-tz-extensions/tz/data`)
    .config(['$logProvider', $logProvider => {
        if(config.get('ui.log')) {
            $logProvider.debugEnabled(config.get('ui.log'));
        }
    }])
    ...
    .config(['$urlRouterProvider', '$breadcrumbProvider', 'QuerySetProvider',
        ...
        function($urlRouterProvider, $breadcrumbProvider, QuerySet,
            ...
            $breadcrumbProvider.setOptions({
                templateUrl: `${config.get('ui.path.static')}partials/breadcrumb.html`
            });
